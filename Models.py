...
class FedAvgCNN(nn.Module):
    def __init__(self, in_features=3, num_classes=10, input_size=32):  # for Cifar10/Cifar100 in_features=3,input_size=32, for mnsit in_features=1, input_size=28
        super().__init__()
        ...
        # 利用一个 dummy tensor 来自动推理 flatten 后的维度
        with torch.no_grad():
            dummy_input = torch.zeros(1, in_features, input_size, input_size)
